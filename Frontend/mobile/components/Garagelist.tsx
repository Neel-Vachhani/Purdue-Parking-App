...
const GARAGE_DEFINITIONS: GarageDefinition[] = [
  ...
  { code: "LOT_H", name: "Lot H (West of Football Practice Field)", lat: 40.41625, lng: -86.91485, passes: ["A", "B", "C"], rating: 2, address: "Lot H, West Lafayette, IN", individual_rating: 0  },
  { code: "LOT_FB", name: "Lot FB (East of Football Practice Field)", lat: 40.41585, lng: -86.91135, passes: ["A", "B"], rating: 2, address: " 1201 Northwestern Ave, West Lafayette, IN", individual_rating: 0  },
  ...
  { code: "LOT_BB", name: "Lot BB (6th & Waldron)", lat: 40.42545, lng: -86.90485, passes: ["A", "B"], rating: 2, address: "1025 6th St, West Lafayette, IN", individual_rating: 0  },
